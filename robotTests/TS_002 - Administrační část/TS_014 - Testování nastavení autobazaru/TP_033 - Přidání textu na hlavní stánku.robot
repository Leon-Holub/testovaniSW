...
TP_033 - Přidání textu na hlavní stánku
    Wait And Click  ${selector-a-addText}
    Wait Until Element Is Visible  ${selector-input-textArea-addText}
    Element Should Be Visible    ${selector-input-textArea-addText}
    Set Focus And Wait  ${selector-input-textArea-addText}
    Check And Input TextArea    ${selector-input-textArea-addText}  ${data-addText-text}
    Wait And Click    ${selector-input-submit-addText}
    Wait Until Element Is Not Visible    ${selector-input-textArea-addText}
    ...
    Check If Text Is Equal    ${selector-h5-offer-addedText}  ${data-addText-text}
